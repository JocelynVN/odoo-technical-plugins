...
- **Static is packaged per component**: an OWL component's js + xml + scss live together in `static/src/components/<component_name>/`, **not** split into separate `js/`, `xml/`, `scss/` folders.
